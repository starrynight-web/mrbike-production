...
export const metadata: Metadata = {
    ...
    description: "Explore motorcycles by brands. Browse all top motorcycle manufacturers in Bangladesh including Yamaha, Honda, Suzuki, and more.",
    openGraph: {
        title: `Motorcycle Brands in Bangladesh${SEO_DEFAULTS.titleSuffix}`,
        description: "Explore motorcycles by brands. Browse all top motorcycle manufacturers in Bangladesh.",
    },
};
