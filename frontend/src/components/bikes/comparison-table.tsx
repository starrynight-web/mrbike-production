    ...
    <div className="border rounded-xl overflow-hidden bg-background shadow-sm">
      ...
      >
        ...
        <div className="contents">
          ...
          {bikes.map((bike) =>
            renderCell(bike, `${bike.rating.average}/5 (${bike.rating.count})`),
          )}
        </div>
        ...
        <div className="contents">
          ...
          {bikes.map((bike) =>
            renderCell(bike, `${bike.specs.displacement}cc`),
          )}
        </div>
        <div className="contents">
          <div className="p-4 font-medium text-muted-foreground bg-muted/5 flex items-center">
          ...
          {bikes.map((bike) =>
            renderCell(bike, bike.specs.maxPower, winners.power === bike.id),
          )}
        </div>
        <div className="contents">
          <div className="p-4 font-medium text-muted-foreground bg-muted/5 flex items-center">
          ...
          {bikes.map((bike) =>
            renderCell(bike, bike.specs.maxTorque, winners.torque === bike.id),
          )}
        </div>
        <div className="contents">
          <div className="p-4 font-medium text-muted-foreground bg-muted/5 flex items-center">
        ...
        <div className="contents">
          ...
          {bikes.map((bike) =>
            renderCell(bike, `${bike.specs.groundClearance} mm`),
          )}
        </div>
