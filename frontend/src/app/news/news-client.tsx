...
export function NewsClient() {
    ...
    const { news, isLoading } = useNews(activeCategory === "all" ? undefined : activeCategory);
                        ...
                        <div className="p-8 lg:p-12 flex flex-col justify-center space-y-6">
                            ...
                            <div className="flex items-center justify-between pt-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="font-semibold text-sm">{featuredNews.author.name}</p>
                                        <p className="text-xs text-muted-foreground">{featuredNews.views.toLocaleString()} reads</p>
                                    </div>
                                </div>
