...
export const metadata: Metadata = {
  ...
  description:
    "Stay updated with the latest motorcycle launches, reviews, price comparisons, and industry news in Bangladesh.",
  openGraph: {
    title: `Latest Bike News & Reviews${SEO_DEFAULTS.titleSuffix}`,
    description:
      "Your daily dose of motorcycle news from Bangladesh and around the world.",
    type: "website",
  },
};
