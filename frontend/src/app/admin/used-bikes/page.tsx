...
export default function UsedBikesModeration() {
    ...
    const filteredListings = listings.filter(listing => {
        const matchesSearch = listing.bike_model.toLowerCase().includes(searchQuery.toLowerCase()) ||
                                            ...
                                            <TableRow key={listing.id} className="group transition-colors hover:bg-muted/30">
                                                <TableCell>
                                                    <div className="h-10 w-10 flex-shrink-0 rounded bg-muted flex items-center justify-center overflow-hidden">
                                                        {listing.image_url ? (
                                                            <img src={listing.image_url} alt={listing.bike_model} className="h-full w-full object-cover" />
                                                        ) : (
                                                ...
                                                <TableCell>
                                                    <div className="space-y-1">
                                                        <div className="flex items-center text-xs text-muted-foreground">
                                                            <MapPin className="mr-1 h-3 w-3" /> {listing.seller_location}
                                                        </div>
                                                        <div className="flex items-center text-xs text-muted-foreground">
                                                            <Calendar className="mr-1 h-3 w-3" /> {listing.year}
                                                        </div>
                                                    </div>
                                                </TableCell>
                                                <TableCell>
