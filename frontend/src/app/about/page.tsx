...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="w-full px-4 md:px-8 py-20 relative z-10">
          <div className="max-w-2xl space-y-4">
            ...
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
              The #1 Motorcycle Ecosystem in{" "}
              <span className="text-primary">Bangladesh</span>
            </h1>
            <p className="text-xl text-muted-foreground leading-relaxed">
              MrBikeBD is dedicated to revolutionizing the way motorcycles are
              bought, sold, and researched in Bangladesh. We combine technology
              with trust to build a safer marketplace.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-3 gap-12">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Every used bike listing goes through a moderation process to
              ensure documentation accuracy and seller legitimacy.
            </p>
          </div>
          <div className="space-y-4">
            <div className="h-12 w-12 rounded-lg bg-primary/10 flex items-center justify-center">
            ...
            <p className="text-muted-foreground">
              Browse through 300+ official models and compare specs, prices, and
              reviews instantly with our advanced compare tool.
            </p>
          </div>
          <div className="space-y-4">
            <div className="h-12 w-12 rounded-lg bg-primary/10 flex items-center justify-center">
            ...
            <p className="text-muted-foreground">
              We design our platform with the rider in mind, focusing on
              usability, accessibility, and honest information.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Founded in 2026, MrBikeBD started as a simple passion project by
                a group of motorcycle enthusiasts who were frustrated by the
                lack of reliable data and the complexities of the second-hand
                market.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Today, we serve thousands of users every month, providing the
                most accurate bike specifications, latest prices, and a secure
                environment for buyers and sellers to connect.
              </p>
      ...
      {/* CTA Section */}
      <div className="w-full px-4 md:px-8 py-20 text-center space-y-8">
        <div className="max-w-xl mx-auto space-y-4">
          <h2 className="text-3xl font-bold tracking-tight">Need help?</h2>
          <p className="text-muted-foreground">
            Our support team is here to assist you with your queries about
            listings, account security, or general feedback.
          </p>
        </div>
