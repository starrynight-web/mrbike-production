...
import { Shield, CheckCircle2, AlertCircle, RefreshCw, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="container py-8 space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Application Routes Debugger</h1>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium">Auth Protected (Est.)</CardTitle>
          </CardHeader>
          <CardContent>
                ...
                <TableRow key={route.path}>
                  <TableCell className="font-mono">
                    <Link 
                        ...
                        className={route.path.includes('[') ? 'cursor-not-allowed text-muted-foreground' : 'text-primary hover:underline'}
                    >
                        {route.path}
                    </Link>
                  </TableCell>
