...
function UsedBikesContent() {
    ...
    const filters = {
        ...
        condition: searchParams.getAll("condition") as any, // Cast to match type
    ...
    if (error) {
        return (
            <div className="text-center py-20 bg-destructive/5 rounded-xl border border-destructive/20">
                <h3 className="text-lg font-semibold text-destructive mb-2">Failed to load bikes</h3>
        ...
        return (
            <div className="text-center py-20 bg-muted/30 rounded-xl border border-dashed">
                ...
                <p className="text-muted-foreground mb-6 max-w-sm mx-auto">
                    We couldn't find any used bikes matching your filters. Try adjusting your search criteria.
                </p>
                <Button variant="outline" onClick={() => window.location.href = '/used-bikes'}>
                    Clear all filters
                </Button>
            </div>
        );
...
export function UsedBikesClient() {
    return (
        <div className="container py-8 md:py-12">
            <h1 className="text-3xl font-bold tracking-tight mb-2">Used Bikes Marketplace</h1>
            <p className="text-muted-foreground mb-8">
                Buy and sell verified used motorcycles in Bangladesh. Find the best deals near you.
            </p>
